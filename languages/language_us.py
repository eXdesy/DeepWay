...
logoutButton = '🚪 LOGOUT'
joinButton = '📥 JOIN'
subscriptionPlansButton = '💳 SUBSCRIPTION PLANS'
paymentButton = '💰 PAYMENT'
buyButton = '🛒 BUY'
monthPaymentPlanButton = '📅 1 MONTH'
threeMonthPaymentPlanButton = '📅 3 MONTHS'
sixMonthPaymentPlanButton = '📅 6 MONTHS'
yearPaymentPlanButton = '📅 1 YEAR'
foreverPaymentPlanButton = '🔒 FOREVER'
paypalButton = '🏦 PAYPAL'
bankCardButton = '💳 BANK CARD'
addMediaButton = '➕ ADD MEDIA'
categoryListButton = '📂 CATEGORIES'
channelsButton = '📢 CHANNELS'
groupsButton = '👥 GROUPS'
userMediaButton = '🎥 MY MEDIA'
searchMediaButton = '🔍 SEARCH'
previousButton = '◀️ PREVIOUS'
nextButton = 'NEXT ▶️'
editButton = '📝 EDIT'
deleteButton = '❌ DELETE'
updateNameButton = '✏️ UPDATE NAME'
updateDescriptionButton = '📝 UPDATE DESCRIPTION'
updatePhotoButton = '📷 UPDATE PHOTO'
...
mainMenuText = (
    '<b>DEEPWAY</b> – your gateway to a world of exclusive content!\n\n'
    '🎟️ Get access to private channels and unique materials.\n'
    '⚡ Manage your subscriptions directly in the bot - even if you lose your account, your access will be preserved!\n'
    '🚀 More features and opportunities are coming soon!'
)
loginMenuText = (
    '👋 Welcome to <b>DEEPWAY</b>!\n\n'
    'Choose what you\'d like to do:\n'
    '🔄 <b>Restore Account</b> - if you lost your account or it got deleted, regain access using your backup code.\n'
    '🔑 <b>Log In</b> - start using the bot by signing into your account.'
)
loginText = (
    '<b>🔑 Log In</b>\n'
    'Already have an account? Enter your password to log in and get access to your subscriptions.\n\n'
    '💡 If forgot your password, use your backup code to restore_user_account access or contact with support!'
)
registerText = (
    '<b>📝 Register</b>\n'
...
supportText = (
    ...
    '💬 Simply describe your problem, and we\'ll get back to you as soon as possible.'
)
supportAnswerText = (
...
subscriptionText = (
    '📌 <b>{group_title}</b>\n'
    '📅 <i>From <b>{formatted_sub_date}</b> to <b>{formatted_exp_date}</b></i>\n\n'
)
noSubscriptionText = (
...
mediaMenuText = (
    'Choose where to search for content:\n\n'
    '👥 <b>Groups</b> – search and browse content in groups.\n'
    '📢 <b>Channels</b> – scroll and select from channels.\n'
    'Use the buttons below to choose ⬇️'
)
userMediaMenuText = (
    'Here you can manage your channels or groups:\n\n'
    '➕ <b>Create</b> – add a new channel or group.\n'
    '✏️ <b>Edit</b> – change the name, description, and settings.\n'
    '❌ <b>Delete</b> – completely remove the channel or group.\n'
    'Use the buttons below to choose ⬇️'
)
mediaChooseText = (
    '<b>{Name}</b>\n'
...
categories = {
    ...
    '✈️ Travel & World': [
        '🌎 Tourism & Travel',
        '🚐 Camping & Vanlife',
        '🏝️ Remote Work & Digital Nomadism',
    ],
